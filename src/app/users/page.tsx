          ...
          >
            ...
            <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div>
                ...
                />
                {formErrors.name && (
                  <p style={{ fontSize: '12px', color: '#ef4444', marginTop: '4px' }}>{formErrors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {formErrors.email && (
                  <p style={{ fontSize: '12px', color: '#ef4444', marginTop: '4px' }}>{formErrors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {formErrors.password && (
                  <p style={{ fontSize: '12px', color: '#ef4444', marginTop: '4px' }}>{formErrors.password}</p>
                )}
              </div>
