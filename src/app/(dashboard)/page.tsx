    ...
    const fetchData = async () => {
      try {
        ...
        setStats({
          ...
          easyQuestions: questions.filter((q: Question) => q.level === "easy")
            .length,
          mediumQuestions: questions.filter(
            (q: Question) => q.level === "medium"
          ).length,
          hardQuestions: questions.filter((q: Question) => q.level === "hard")
            .length,
        });
      } catch {
    ...
    <div style={{ padding: "24px" }}>
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "4px" }}>
          Tổng quan hệ thống English Quiz
        </p>
      </div>
